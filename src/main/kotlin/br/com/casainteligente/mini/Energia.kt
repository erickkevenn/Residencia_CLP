...
data class CustosEnergia(
    val custoHoraBRL: Double,
    val custoDiaBRL: Double,
    val custoMesBRL: Double
)

fun SnapshotEnergia.custos(precoKWhBRL: Double): CustosEnergia {
    val kWhHora = this.totalWatts / 1000.0
    val hora = kWhHora * precoKWhBRL
    val dia = hora * 24.0
    val mes = dia * 30.0
    return CustosEnergia(hora, dia, mes)
}
